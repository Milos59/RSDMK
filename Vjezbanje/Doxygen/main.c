...
/// Makro za definisanje visoke vrijednosti signala
#define HIGH 1

/// Makro za definisanje niske vrijednosti signala
#define LOW 0
...
/**
 * pinPulse - funkcija koja implementira treptaj
 ...
 * @return - nema povratnu vrijenost
 */
...
unsigned long timer0DelayMs(unsigned long delay_length)
{
	...
	t0 = ms;
	while ((ms - t0) < delay_length); // Pauza delay_length milisekundi
	return ms;
}
/******************************************************************************************/
